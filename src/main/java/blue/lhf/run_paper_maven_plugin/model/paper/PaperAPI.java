...
public class PaperAPI {
    ...
    public static V3 get() {
        return V3.INSTANCE;
    }

    public static class V3 implements API<Build> {
        private static final V3 INSTANCE = new V3();

        private static final URI          BASE = URI.create("https://fill.papermc.io/");
        private static final URI    LOCAL_BASE =          BASE.resolve("v3/"      );
        ...
        public CompletableFuture<SortedSet<Build>> fetchBuilds(String version) throws APIException {
            ...
            return future
                .thenApplyAsync(response -> PaperAPI.handleErrors(response, status -> {
                    if (status == 404) {
                ...
                .thenApplyAsync(PaperAPI.V3::parseVersionInformation)
        ...
        public static class DownloadInformation {
            ...
            public Map<String, String> checksums = Map.of();
        ...
        public CompletableFuture<DownloadInformation> fetchInformation(final Build build) throws APIException {
            ...
            return client.sendAsync(request, ofInputStream())
                ...
                .thenApplyAsync(PaperAPI.V3::parseBuildInformation)
                .thenApply(information -> {
                    ...
                    final HashMap<String, Object> map = (HashMap<String, Object>) (Object)
                        information.downloads.get("server:default");
        ...
        public CompletableFuture<Download> fetchApplication(Build build) throws APIException {
            return fetchInformation(build).thenCompose(information -> {
                final URI downloadURI = URI.create(information.url);
                ...
                return client.sendAsync(request, ofInputStream())
                    ...
                    .thenApplyAsync(response -> toDownload(response, information.checksums.getOrDefault("sha256", null)));
            });
        }
    }
    ...
    public static class V2 implements API<Build> {
        ...
        private static VersionInformation parseVersionInformation(final HttpResponse<InputStream> response) {
            try (Json json = new Json(response.body())) {
                return json.toObject(VersionInformation.class);
            }
        }

        private static BuildInformation parseBuildInformation(final HttpResponse<InputStream> response) {
            try (Json json = new Json(response.body())) {
                return json.toObject(BuildInformation.class);
            }
        }
        ...
        //region Download JAR
        private static class BuildInformation {
            public Map<String, DownloadInformation> downloads = Map.of();
        }

        private static class DownloadInformation {
            public String name = null;
            public String sha256 = null;
        }

        private URI getURI(final Build build) {
            return VERSIONS_BASE.resolve("%s/builds/%s/".formatted(build.version(), build.identifier()));
        }

        private CompletableFuture<DownloadInformation> fetchInformation(final Build build) throws APIException {
            final URI fetchURI = getURI(build);
